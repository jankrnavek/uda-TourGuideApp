...
public class AccommodationsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0 ; i <=20 ; i++) {
            dc.add(new DataContener(getString(R.string.fragment_accommodations), "Hotel title " + i, getString(R.string.my_small_text), getString(R.string.my_long_text), R.drawable.hotel));
        }
